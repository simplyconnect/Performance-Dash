...
(() => {
  ...
  function wireStaticUI() {
    ...
    $('#rail_closerperf').addEventListener('click', () => switchPage('closerperf'));

    // Lead Gen Performance tab
    $('#rail_leadperf').addEventListener('click', () => switchPage('leadperf'));
  }
  ...
  function switchPage(id) {
    ...
    $('#page-closers').hidden = id !== 'closerperf';
    $('#page-leads').hidden = id !== 'leadperf';
    ...
    if (id === 'hourly') {
      ...
      $('#rail_closerperf').setAttribute('aria-current', 'page');
      window.scrollTo({ top: 0, behavior: 'smooth' });
    } else if (id === 'leadperf') {
      $('#rail_leadperf').setAttribute('aria-current', 'page');
      window.scrollTo({ top: 0, behavior: 'smooth' });
    } else {
